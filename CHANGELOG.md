...
## [0.1.14] (2026-04-20)
### Added
* type safety for units: enum HardwareValue

### Changed
* comment outs: `info!()` in `get_address_info()`
...
[Unreleased]: https://github.com/aki-akaguma/webapp-broinfo/compare/v0.1.14..HEAD
